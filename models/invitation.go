...
type Invitation struct {
	...
	EventSchedule     []EventSchedule     `gorm:"constraint:OnUpdate:CASCADE,OnDelete:CASCADE" json:"-"`
	GalleryInvitation []GalleryInvitation `gorm:"constraint:OnUpdate:CASCADE,OnDelete:CASCADE" json:"-"`
	MusicInvitation   []MusicInvitation   `gorm:"constraint:OnUpdate:CASCADE,OnDelete:CASCADE" json:"-"`
	ModelDefault
}
